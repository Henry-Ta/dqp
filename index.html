    ...
    <section id="header">
      <div class="header container">
        <div class="nav-bar">
          <div class="brand">
            <a href="#hero"
              ><h1><span>D</span>Q<span>P</span></h1></a
            >
          </div>
          <div class="nav-list">
            ...
            <ul>
              ...
              <li><a href="#projects" data-after="Projects">Sản Phẩm</a></li>
  ...
  -->
    ...
    <section id="projects">
      <div class="projects container">
        <div class="projects-header">
          <h1 class="section-title">Sản Phẩm <span>Nổi Bật</span></h1>
        </div>
        <div class="all-projects">
          <div class="project-item">
            <div class="project-info">
              <h1>Sản Phẩm</h1>
              <h2>Homecook by DQP</h2>
              <p>
    ...
    <section id="about">
      <div class="about container">
        <div class="col-left">
          <div class="about-img">
            <img src="./img/hero-bg.png" alt="img" />
          </div>
        </div>
        <div class="col-right">
          <h1 class="section-title">About <span>DQP</span></h1>
          <h2>Homecook</h2>
          <p>
    ...
    <section id="contact">
      <div class="contact container">
        <div>
          <h1 class="section-title">Ý Kiến <span> Khách Hàng</span></h1>
        </div>
        <div class="contact-items">
          <div class="contact-item">
            ...
            <div class="contact-info">
              <h1><i>"Sản phẩm này rất tốt, ăn rất ngon"</i></h1>
              <!--<h2>This product is awesome</h2>-->
              <h2>Henry</h2>
            </div>
          </div>
          <div class="contact-item">
    ...
    <section id="footer">
      <div class="footer container">
        <div class="brand">
          <h1><span>D</span>q <span>P</span></h1>
        </div>
        <h2>Homecook by DQP</h2>
        <div class="social-icon">
          <div class="social-item">
            <a href="https://www.facebook.com/enrose.lavie.0/"
              ><img
                src="https://img.icons8.com/bubbles/100/000000/facebook-new.png"
            /></a>
          </div>
          <div class="social-item">
            <a href="https://www.instagram.com/h.e.n.r.y.t.a/"
              ><img
        ...
        --></div>
        <p>Copyright © 2020 Henry Ta. All rights reserved</p>
      </div>
    </section>
    <!-- End Footer -->
